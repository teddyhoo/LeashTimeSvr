...
function emailMasterSchedule() {
	...
	if(!$scriptPrefs['masterSchedule']) 
		echo "Master Schedule feature not turned on.<br>";
		...
		if($recips) {
			...
			echo "QUEUEING MASTER SCHEDULE:  ($days days) for $allAdds.<br>";
			echo "---------------------MASTER SCHEDULE ENQUEUE EMAIL NOTIFICATION------------------------------";
			echo "$first \n\n";
			echo "$cc\n\n"
			echo "$schedule\n\n";
