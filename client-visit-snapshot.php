...
if($futureVisit && !$appt['canceled']) {
	...
	if($tooLateToCancel && time() + (60 * 60 * $tooLateToCancel) > strtotime($appt['date'].' '.$appt['starttime']))
		$actionDiv .= "<b><font color=red>{$_SESSION['preferences']['cancellationDeadlineWarning']}</font></b>";
}	
