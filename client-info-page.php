...
foreach(visibleDocumentLinks('Clients') as $item) {
	...
	$download = "<i class=\"fa fa-download fa-1x\" style=\"display:inline;color:gray;cursor:pointer;\" title=\"Download\" ONCLICK></i>";
...
if($_SESSION['preferences']['bizHomePage'])
	echo "You can learn more about $standardLabel at our website: <b style='font-size:1.2em'><a href='{$_SESSION['preferences']['bizHomePage']}' target='bizHomePage'>$standardLabel</a></b><p>";

echo "<div class='fontSize1_5em'>";
if($standardDocs) {
	echo "\n<h3>$standardLabel Documents</h3>";
	echo "\n<p>Click a link to view the document or the download icon ($download) to retrieve it.</p>";
