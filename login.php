...
$loginid = "{$_POST['user_name']}" ? "{$_POST['user_name']}" : '??';
...
if($suspiciousLoginId) $suspiciousLoginId = mysqli_real_escape_string($suspiciousLoginId);

$loginRecord =
	array('LoginID'=>($suspiciousLoginId ? $suspiciousLoginId : $loginid), 
				'Success'=>($failure ? '0' : '1'), 
