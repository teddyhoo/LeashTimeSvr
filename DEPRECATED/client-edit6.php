	...
	if($_SESSION['ccenabled']) {
		...
		if($client['clientid']) {
			...
			if ($_SESSION['preferences']['ccGateway'] == 'Solveras'){
				$gatewayname = $_SESSION['preferences']['ccGateway'];
				
				include "solveras-gateway-class2.php";
				$gateway = new SolverasGateway();
				if ($gateway->supportsACH()) {
					echo "<tr><td colspan=2>SUPPORTS ACH<hr></td></tr>";
				} else {
					echo "<tr><td colspan=2>NOT SUPPORT ACH<hr></td></tr>";
				}
				if ($_SESSION['preferences']['gatewayOfferACH']) {
					echo "<tr><td colspan=2>offer ACH: YES<hr></td></tr>";
				} else {
					echo "<tr><td colspan=2>no offer ACH<hr></td></tr>";
				}
				
				echo "<tr><td colspan=2>ACH OFFERED:" . $_SESSION['preferences']['gatewayOfferACH'] . "<hr></td></tr>";

				if ($gateway->supportsACH() && $_SESSION['preferences']['gatewayOfferACH']) {
