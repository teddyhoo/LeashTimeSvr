...
body {
	...
	background-image:url('art/bg-mobile-client-blue.jpg'); 
...
.toctable {background-color:transparent;}
.toctable td {padding:10px; font-family:Arial, Helvetica, sans-serif; color: black; font-size:1.2em;background-color:transparent;} 
</style>";
...
$choices = "calendar|home-client-mobile.php
