...
if(!$petnames) {
	$clientIds = fetchCol0($sql = "SELECT clientid FROM tblclient $whereClause");
...
//if(mattOnlyTEST()) {echo "$sql size: ".count($clients)."<hr>";exit;}
...
//if(mattOnlyTEST()) {echo "$sql size: ".count($clients)." numClients: $numClients<hr>";exit;}
